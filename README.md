...
- [Part 1: Why?](#part-1-why)
- [Part 2: What ?](#part-2-what)
- [Part 3: How?](#part-3-how)
...
- Competence After Finishing the Course
  - Understanding of the entire development life cycle: [Roadmap FS].
  - Tools and technologies that power modern web development.
  - Soft skills
- Financial Opportunities
  - In Finland, Junior web developers earn a competitive salary, with an average of around 4500€ **Not Trainee**
...
- Comparable courses on other platforms, such as bootcamps or online academies, can cost upwards of 30k. 
- [Bootcamp: Berkeley]
- [Bootcamp: EDX]
- [App academy]
- [Ironhack]
- [Coding Bootcamps with Job Guarantee]
...
- Course operates at a fast pace, reflecting the industry's dynamic nature.
- You'll need to invest dedicated time and effort.
...
- 15 credits: 405 hours in 10 weeks
...
- [Roadmap FS].
- Mastering both the frontend and backend 
- DevOps
...
>  3 sessions: Front end , backend, project
...
- [Homework]
- [Preparation Phase](https://github.com/fullstack-prep/assignments)
- Signup
